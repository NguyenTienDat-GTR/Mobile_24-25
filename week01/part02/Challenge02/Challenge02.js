...
code from first tip calculator challenge if you need to). Use the function type you
...
/* task 3 Create an array 'tips' containing the tip value for each bill, calculated from the
